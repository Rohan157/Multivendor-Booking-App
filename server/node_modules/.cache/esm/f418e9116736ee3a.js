let User,jwt;_673‍.x([["register",()=>register],["login",()=>login]]);_673‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_673‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
// };
  ...
  try {
    ...
    await user.save();
    _673‍.g.console.log("USER CREATED", user);
    return res.json({ ok: true });
  } catch (err) {
    _673‍.g.console.log("CREATE USER FAILED", err);
  ...
  try {
    ...
    user.comparePassword(password, (err, match) => {
      _673‍.g.console.log("COMPARE PASSWORD IN LOGIN ERR", err);
    ...
    _673‍.g.console.log("LOGIN ERROR", err);
