let User,Stripe,queryString,Hotel,Order,order;_6e6‍.x([["createConnectAccount",()=>createConnectAccount],["getAccountStatus",()=>getAccountStatus],["getAccountBalance",()=>getAccountBalance],["payoutSetting",()=>payoutSetting],["stripeSessionId",()=>stripeSessionId],["stripeSuccess",()=>stripeSuccess]]);_6e6‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_6e6‍.w("stripe",[["default",["Stripe"],function(v){Stripe=v}]]);_6e6‍.w("query-string",[["default",["queryString"],function(v){queryString=v}]]);_6e6‍.w("../models/hotel",[["default",["Hotel"],function(v){Hotel=v}]]);_6e6‍.w("../models/order",[["default",["Order","order"],function(v){Order=order=v}]]);
...
const stripe = Stripe(process.env.STRIPE_SECRET);
  ...
  if (!user.stripe_account_id) {
    ...
    _6e6‍.g.console.log("ACCOUNT ===>", account);
...
const updateDelayDays = async (accountId) => {
  ...
  try {
    ...
    _6e6‍.g.console.log("BALANCE ===>", balance);
    // res.json(balance);
  } catch (err) {
    _6e6‍.g.console.log(err);
  }
};
  ...
  try {
    ...
    _6e6‍.g.console.log("STRIPE PAYOUT SETTING ERROR", err);
  }
};
  ...
  try {
    ...
    _6e6‍.g.console.log("STRIPE SUCCESS ERROR", err);
  }
};
