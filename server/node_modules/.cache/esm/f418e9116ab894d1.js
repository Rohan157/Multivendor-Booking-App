let User,jwt;_6ab‍.x([["register",()=>register],["login",()=>login]]);_6ab‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_6ab‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
// };
  ...
  try {
    await user.save();
    _6ab‍.g.console.log("USER CREATED", user);
    return res.json({ ok: true });
  } catch (err) {
    _6ab‍.g.console.log("CREATE USER FAILED", err);
  ...
  try {
    ...
    user.comparePassword(password, (err, match) => {
      _6ab‍.g.console.log("COMPARE PASSWORD IN LOGIN ERR", err);
    ...
    _6ab‍.g.console.log("LOGIN ERROR", err);
