let User,jwt;_b58‍.x([["register",()=>register],["login",()=>login]]);_b58‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_b58‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
// };
  ...
  try {
    await user.save();
    _b58‍.g.console.log("USER CREATED", user);
    return res.json({ ok: true });
  } catch (err) {
    _b58‍.g.console.log("CREATE USER FAILED", err);
  ...
  try {
    ...
    user.comparePassword(password, (err, match) => {
      _b58‍.g.console.log("COMPARE PASSWORD IN LOGIN ERR", err);
    ...
    _b58‍.g.console.log("LOGIN ERROR", err);
